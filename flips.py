...
more_flips = [
    # Emerald
    BazaarNPCFlip("Emerald", None, 6.0),
    BazaarNPCFlip("Enchanted Emerald", None, 960.0),
    BazaarNPCFlip("Enchanted Emerald Block", None, 153600.0),
    # Redstone
    BazaarNPCFlip("Redstone", None, 1.0),
    BazaarNPCFlip("Enchanted Redstone", None, 160.0),
    BazaarNPCFlip("Enchanted Redstone Block", None, 25600.0),
    # Quartz
    BazaarNPCFlip("Quartz", None, 4.0),
    BazaarNPCFlip("Enchanted Quartz", None, 640.0),
    BazaarNPCFlip("Enchanted Quartz Block", None, 102000.0),
    # Obby
    BazaarNPCFlip("Obsidian", None, 9.0),
    BazaarNPCFlip("Enchanted Obsidian", None, 1920.0),
    # Glowstone
    BazaarNPCFlip("Glowstone Dust", None, 2.0),
    BazaarNPCFlip("Enchanted Glowstone Dust", None, 320.0),
    BazaarNPCFlip("Enchanted Glowstone", None, 61000.0),
    BazaarNPCFlip("Enchanted Redstone Lamp", None, 30720.0),
    # Flint
    BazaarNPCFlip("Flint", None, 4.0),
    BazaarNPCFlip("Enchanted Flint", None, 640.0),
    BazaarNPCFlip("Gravel", None, 3.0),
    # Hard Stone
    BazaarNPCFlip("Hard Stone", None, 1.0),
    BazaarNPCFlip("Enchanted Hard Stone", None, 576.0),
    BazaarNPCFlip("Concentrated Stone", None, 331776.0),
    # Ice
    BazaarNPCFlip("Ice", None, 0.5),
    BazaarNPCFlip("Packed Ice", None, 4.5),
    BazaarNPCFlip("Enchanted Ice", None, 80.0),
    BazaarNPCFlip("Enchanted Packed Ice", None, 12800.0),
    # Netherrack
    BazaarNPCFlip("Netherrack", None, 1.0),
    BazaarNPCFlip("Enchanted Netherrack", None, 160.0),
    # Sand
    BazaarNPCFlip("Sand", None, 2.0),
    BazaarNPCFlip("Enchanted Sand", None, 320.0),
    # Snow
    BazaarNPCFlip("Snowball", "SNOW_BALL", 1.0),
    BazaarNPCFlip("Snow Block", None, 4.0),
    BazaarNPCFlip("Enchanted Snow Block", None, 600.0),
    # Mithril
    BazaarNPCFlip("Mithril", "MITHRIL_ORE", 10),
    BazaarNPCFlip("Enchanted Mithril", None, 1600.0),
    BazaarNPCFlip("Refined Mithril", None, 256000.0),
    BazaarNPCFlip("Titanium", "TITANIUM_ORE", 20),
    BazaarNPCFlip("Enchanted Titanium", None, 3200.0),
    BazaarNPCFlip("Refined Titanium", None, 51200.0),
    BazaarNPCFlip("Starfall", None, 15.0),
    BazaarNPCFlip("Treasurite", None, 5000.0)
]
flips += more_flips
